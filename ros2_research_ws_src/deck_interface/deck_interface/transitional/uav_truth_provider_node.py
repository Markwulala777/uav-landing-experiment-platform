...
from uav_usv_landing_msgs.msg import UavState


class UavTruthProviderNode(Node):
    def __init__(self):
        super().__init__("uav_truth_provider")
        ...
        self.uav_pose_debug_pub = self.create_publisher(PoseStamped, "/deck_interface/truth/uav_pose", 10)
        self.uav_twist_debug_pub = self.create_publisher(TwistStamped, "/deck_interface/truth/uav_twist", 10)
        ...
        self.get_logger().info(
            "deck_interface transitional UAV truth provider is running. "
