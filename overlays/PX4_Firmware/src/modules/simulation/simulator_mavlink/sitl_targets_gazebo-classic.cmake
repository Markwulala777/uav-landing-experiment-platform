...
if(gazebo_FOUND)
	...
	set(sitl_gazebo-classic_mavlink_dir ${PX4_BINARY_DIR}/sitl_gazebo-classic_mavlink)
	set(sitl_gazebo-classic_mavlink_header ${sitl_gazebo-classic_mavlink_dir}/development/mavlink.h)
	add_custom_command(
		OUTPUT ${sitl_gazebo-classic_mavlink_header}
		COMMAND ${CMAKE_COMMAND} -E remove_directory ${sitl_gazebo-classic_mavlink_dir}
		COMMAND ${CMAKE_COMMAND} -E make_directory ${sitl_gazebo-classic_mavlink_dir}
		COMMAND ${PYTHON_EXECUTABLE} ${PX4_SOURCE_DIR}/src/modules/mavlink/mavlink/pymavlink/tools/mavgen.py
			--lang C
			--wire-protocol 2.0
			--output ${sitl_gazebo-classic_mavlink_dir}
			${PX4_SOURCE_DIR}/src/modules/mavlink/mavlink/message_definitions/v1.0/development.xml
		DEPENDS
			git_mavlink_v2
			${PX4_SOURCE_DIR}/src/modules/mavlink/mavlink/pymavlink/tools/mavgen.py
			${PX4_SOURCE_DIR}/src/modules/mavlink/mavlink/message_definitions/v1.0/development.xml
		COMMENT "Generating MAVLink development headers for sitl_gazebo-classic"
	)
	add_custom_target(sitl_gazebo-classic_mavlink_headers DEPENDS ${sitl_gazebo-classic_mavlink_header})
	...
	ExternalProject_Add(sitl_gazebo-classic
		...
		CMAKE_ARGS
			...
			-D_MAVLINK_INCLUDE_DIR:PATH=${sitl_gazebo-classic_mavlink_dir}
		BINARY_DIR ${PX4_BINARY_DIR}/build_gazebo-classic
		INSTALL_COMMAND ""
		DEPENDS git_sitl_gazebo-classic sitl_gazebo-classic_mavlink_headers
