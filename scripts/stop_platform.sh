...
TARGET_PATTERNS=(
  ...
  "$INSTALL_ROOT/ros2_research_ws/install/deck_interface/lib/deck_interface/deck_truth_ingest"
  "$INSTALL_ROOT/ros2_research_ws/install/deck_interface/lib/deck_interface/landing_zone_state"
  "$INSTALL_ROOT/ros2_research_ws/install/deck_interface/lib/deck_interface/uav_truth_provider"
